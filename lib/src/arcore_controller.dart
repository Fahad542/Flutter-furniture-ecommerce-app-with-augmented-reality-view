...
import 'package:mart/src/arcore_augmented_image.dart';
import 'package:mart/src/arcore_rotating_node.dart';
...
//  UnsupportedHandler onUnsupported;
  ...
  Future<void> addArCoreNode(ArCoreNode node,
  ...
  Future<Future> togglePlaneRenderer() async {
    return _channel.invokeMethod('togglePlaneRenderer');
  }

  Future<Future> getTrackingState() async {
  ...
  Map _addParentNodeNameToParams(Map geometryMap, String parentNodeName) {
