...
const Color redColor = Color.fromARGB(234, 255, 6, 6);
const Color blueColor = Color.fromARGB(255, 0, 124, 161);

const Color golden = Color.fromARGB(255, 255, 136, 0);
const Color lightGolden = Color.fromARGB(255, 255, 208, 0);
